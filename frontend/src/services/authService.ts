...
const authService = {
  ...
  initiateAzureLogin() {
    ...
    const tenantName = process.env.REACT_APP_AZURE_AD_B2C_TENANT || 'lucapb2c';
    const clientId = process.env.REACT_APP_AZURE_AD_B2C_CLIENT_ID || '11111111-1111-1111-1111-111111111111';
    const signInPolicy = process.env.REACT_APP_AZURE_AD_B2C_SIGNIN_POLICY || 'B2C_1_signupsignin';
